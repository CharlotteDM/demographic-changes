...
__```r sd(comb_data_agewom_fr_contr_gdp$X2019)```__ , what it means, that the values observed are centered around the mean.

Correlation between __mean age at the birth of first child__ and __GDP__ is
__```r cor(comb_data_agewom_fr_contr_gdp$OBS_VALUE,comb_data_agewom_fr_contr_gdp$GDP_per_cap)```__ This correlation is strong. 
...
__```r cor(comb_data_agewom_fr_contr_gdp$AnyMethod, comb_data_agewom_fr_contr_gdp$GDP_per_cap, use = "complete.obs")```__ and it also strong. 
...
Animation shows death rate in Polan since 1960 to 2019:
