...
__```r round(sd(comb_data_agewom_fr_contr_gdp$X2019), 2)```__ , what it means, that the values observed are centered around the mean value.
...
This is graphical representation of death rate in 2019.
...
(_More information in my next project_).
